...
这个项目原理在于用可量化的方法验证两个输出结果在颜色上是否一致。
初版测试对象为 Davinci 和 Filmora
...
- 图像算法和产品团队：验证版本迭代前后的色彩一致性
- VBL及上游团队：比较不同宿主、不同平台、不同接口链路的输出差异
- QA 与测试团队：快速复现并解释“颜色不一致”的问题
- 用户：量化检查参考图与测试图之间的色彩偏差
